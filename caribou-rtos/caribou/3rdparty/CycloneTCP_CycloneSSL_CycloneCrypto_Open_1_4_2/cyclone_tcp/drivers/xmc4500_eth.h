...
#ifndef XMC4500_TX_BUFFER_COUNT
   #define XMC4500_TX_BUFFER_COUNT 3
#elif (XMC4500_TX_BUFFER_COUNT < 1)
   #error XMC4500_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef XMC4500_TX_BUFFER_SIZE
   #define XMC4500_TX_BUFFER_SIZE 1536
#elif (XMC4500_TX_BUFFER_SIZE != 1536)
   #error XMC4500_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef XMC4500_RX_BUFFER_COUNT
   #define XMC4500_RX_BUFFER_COUNT 6
#elif (XMC4500_RX_BUFFER_COUNT < 1)
   #error XMC4500_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef XMC4500_RX_BUFFER_SIZE
   #define XMC4500_RX_BUFFER_SIZE 1536
#elif (XMC4500_RX_BUFFER_SIZE != 1536)
   #error XMC4500_RX_BUFFER_SIZE parameter is not valid
#endif
