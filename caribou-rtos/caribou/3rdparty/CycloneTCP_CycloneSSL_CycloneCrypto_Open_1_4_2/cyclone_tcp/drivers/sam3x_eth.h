...
#ifndef SAM3X_TX_BUFFER_COUNT
   #define SAM3X_TX_BUFFER_COUNT 3
#elif (SAM3X_TX_BUFFER_COUNT < 1)
   #error SAM3X_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef SAM3X_TX_BUFFER_SIZE
   #define SAM3X_TX_BUFFER_SIZE 1536
#elif (SAM3X_TX_BUFFER_SIZE != 1536)
   #error SAM3X_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef SAM3X_RX_BUFFER_COUNT
   #define SAM3X_RX_BUFFER_COUNT 72
#elif (SAM3X_RX_BUFFER_COUNT < 12)
   #error SAM3X_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef SAM3X_RX_BUFFER_SIZE
   #define SAM3X_RX_BUFFER_SIZE 128
#elif (SAM3X_RX_BUFFER_SIZE != 128)
   #error SAM3X_RX_BUFFER_SIZE parameter is not valid
#endif
