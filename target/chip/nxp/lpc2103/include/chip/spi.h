...
* ----------------------------------------------------------------------------
*
* @brief Define the UART device driver API
* @author Mike Sharkey <mike@pikeaero.com>
*
******************************************************************************/
#ifndef _CARIBOU_CHIP_SPI_LPC2103_H_
#define _CARIBOU_CHIP_SPI_LPC2103_H_
...
#define chip_spi_port_t	volatile uint32_t*
...
void chip_spi_tx(chip_spi_port_t, chip_spi_word_t word);
