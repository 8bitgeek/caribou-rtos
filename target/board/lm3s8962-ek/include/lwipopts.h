 ...
 */
#if !defined(PRODUCT_THREAD_DEF_STKSZ)
	#define PRODUCT_THREAD_DEF_STKSZ	1024
#endif
#define TCPIP_THREAD_STACKSIZE          PRODUCT_THREAD_DEF_STKSZ
 ...
 * sys_thread_new() when the thread is created.
 */
#if !defined(PRODUCT_THREAD_NORMAL_PRIO)
	#define PRODUCT_THREAD_NORMAL_PRIO	1
#endif
#define TCPIP_THREAD_PRIO               PRODUCT_THREAD_NORMAL_PRIO
