...
/* SPI2 (CC3000 WiFi) *********************************************************
		...
		SPI2 NSS  - T.I. CC3000 WiFi -----> PB12
		SPI2 SCK  - T.I. CC3000 WiFi -----> PB13
		SPI2 MISO - T.I. CC3000 WiFi -----> PB14
		SPI2 MOSI - T.I. CC3000 WiFi -----> PB15
		CC3000 ENABLE --------------------> PG12
		CC3000 INTERRUPT -----------------> PG15

******************************************************************************/

/* UART1 (MAX3232 Serial) *****************************************************
...
#define	CARIBOU_PORTA_MODE		PIN_MODE(0,GPIO_Mode_IN) |	\
								...
								PIN_MODE(9,GPIO_Mode_AF) |			/* UART1 TX */			\
								PIN_MODE(10,GPIO_Mode_AF) |			/* UART1 RX */			\
								PIN_MODE(11,GPIO_Mode_AF) |			/* UART1 CTS */			\
								PIN_MODE(12,GPIO_Mode_AF) |			/* UART1 RTS */			\
...
#define	CARIBOU_PORTA_OTYPER	PIN_OTYPER(0,GPIO_OType_PP) |	\
								...
								PIN_OTYPER(9,GPIO_OType_PP) |		/* UART1 TX */			\
								PIN_OTYPER(10,GPIO_OType_PP) |		/* UART1 RX */			\
								PIN_OTYPER(11,GPIO_OType_PP) |		/* UART1 CTS */			\
								PIN_OTYPER(12,GPIO_OType_PP) |		/* UART1 RTS */			\
...
#define	CARIBOU_PORTA_OSPEEDR	PIN_OSPEEDR(0,GPIO_Speed_2MHz) |	\
								...
								PIN_OSPEEDR(9,GPIO_Speed_2MHz) |	/* UART1 TX */			\
								PIN_OSPEEDR(10,GPIO_Speed_2MHz) |	/* UART1 RX */			\
								PIN_OSPEEDR(11,GPIO_Speed_2MHz) |	/* UART1 CTS */			\
								PIN_OSPEEDR(12,GPIO_Speed_2MHz) |	/* UART1 RTS */			\
...
#define	CARIBOU_PORTA_PUPDR		PIN_PUPDR(0,GPIO_PuPd_NOPULL) |	\
								...
								PIN_PUPDR(9,GPIO_PuPd_NOPULL) |		/* UART1 TX */			\
								PIN_PUPDR(10,GPIO_PuPd_NOPULL) |	/* UART1 RX */			\
								PIN_PUPDR(11,GPIO_PuPd_NOPULL) |	/* UART1 CTS */			\
								PIN_PUPDR(12,GPIO_PuPd_NOPULL) |	/* UART1 RTS */			\
...
#define	CARIBOU_PORTA_AFRH		PIN_AFR(0,GPIO_AF_GPIO) |	\
								PIN_AFR(1,GPIO_AF_USART1) |			/* UART1 TX */			\
								PIN_AFR(2,GPIO_AF_USART1) |			/* UART1 RX */			\
								PIN_AFR(3,GPIO_AF_USART1) |			/* UART1 CTS */			\
								PIN_AFR(4,GPIO_AF_USART1) |			/* UART1 RTS */			\
...
#define	CARIBOU_PORTB_MODE		PIN_MODE(0,GPIO_Mode_IN) |	\
								...
								PIN_MODE(12,GPIO_Mode_AF) |			/* SPI2 NSS  - T.I. CC3000 WiFi */	\
								PIN_MODE(13,GPIO_Mode_AF) |			/* SPI2 SCK  - T.I. CC3000 WiFi */	\
								PIN_MODE(14,GPIO_Mode_AF) |			/* SPI2 MISO - T.I. CC3000 WiFi */	\
								PIN_MODE(15,GPIO_Mode_AF)			/* SPI2 MOSI - T.I. CC3000 WiFi */
...
#define	CARIBOU_PORTB_OTYPER	PIN_OTYPER(0,GPIO_OType_PP) |	\
								...
								PIN_OTYPER(12,GPIO_OType_PP) |		/* SPI2 NSS  - T.I. CC3000 WiFi */	\
								PIN_OTYPER(13,GPIO_OType_PP) |		/* SPI2 SCK  - T.I. CC3000 WiFi */	\
								PIN_OTYPER(14,GPIO_OType_PP) |		/* SPI2 MISO - T.I. CC3000 WiFi */	\
								PIN_OTYPER(15,GPIO_OType_PP)		/* SPI2 MOSI - T.I. CC3000 WiFi */
...
#define	CARIBOU_PORTB_OSPEEDR	PIN_OSPEEDR(0,GPIO_Speed_2MHz) |	\
								...
								PIN_OSPEEDR(12,GPIO_Speed_25MHz) |	/* SPI2 NSS  - T.I. CC3000 WiFi */	\
								PIN_OSPEEDR(13,GPIO_Speed_25MHz) |	/* SPI2 SCK  - T.I. CC3000 WiFi */	\
								PIN_OSPEEDR(14,GPIO_Speed_25MHz) |	/* SPI2 MISO - T.I. CC3000 WiFi */	\
								PIN_OSPEEDR(15,GPIO_Speed_25MHz)	/* SPI2 MOSI - T.I. CC3000 WiFi */
...
#define	CARIBOU_PORTB_PUPDR		PIN_PUPDR(0,GPIO_PuPd_NOPULL) |	\
								...
								PIN_PUPDR(12,GPIO_PuPd_NOPULL) |	/* SPI2 NSS  - T.I. CC3000 WiFi */	\
								PIN_PUPDR(13,GPIO_PuPd_NOPULL) |	/* SPI2 SCK  - T.I. CC3000 WiFi */	\
								PIN_PUPDR(14,GPIO_PuPd_NOPULL) |	/* SPI2 MISO - T.I. CC3000 WiFi */	\
								PIN_PUPDR(15,GPIO_PuPd_NOPULL)		/* SPI2 MOSI - T.I. CC3000 WiFi */
...
#define	CARIBOU_PORTB_AFRH		PIN_AFR(0,GPIO_AF_GPIO) |	\
								...
								PIN_AFR(2,GPIO_AF_GPIO) |	\
								PIN_AFR(3,GPIO_AF_GPIO) |	\
								PIN_AFR(4,GPIO_AF_SPI2) |	/* SPI2 NSS  - T.I. CC3000 WiFi */	\
								PIN_AFR(5,GPIO_AF_SPI2) |	/* SPI2 SCK  - T.I. CC3000 WiFi */	\
								PIN_AFR(6,GPIO_AF_SPI2) |	/* SPI2 MISO - T.I. CC3000 WiFi */	\
								PIN_AFR(7,GPIO_AF_SPI2)		/* SPI2 MOSI - T.I. CC3000 WiFi */
/**
 ** PORT C
 */
...
#define	CARIBOU_PORTF_OTYPER	PIN_OTYPER(0,GPIO_OType_PP) |	\
								...
								PIN_OTYPER(4,GPIO_OType_PP) |	\
								PIN_OTYPER(5,GPIO_OType_PP) |	\
								PIN_OTYPER(6,GPIO_OType_PP) |			/* LED1 */	\
								PIN_OTYPER(7,GPIO_OType_PP) |	\
								PIN_OTYPER(8,GPIO_OType_PP) |	\
								PIN_OTYPER(9,GPIO_OType_PP) |	\
								PIN_OTYPER(10,GPIO_OType_PP) |	\
...
#define	CARIBOU_PORTF_OSPEEDR	PIN_OSPEEDR(0,GPIO_Speed_2MHz) |	\
								...
								PIN_OSPEEDR(4,GPIO_Speed_2MHz) |	\
								PIN_OSPEEDR(5,GPIO_Speed_2MHz) |	\
								PIN_OSPEEDR(6,GPIO_Speed_2MHz) |			/* LED1 */	\
								PIN_OSPEEDR(7,GPIO_Speed_2MHz) |	\
								PIN_OSPEEDR(8,GPIO_Speed_2MHz) |	\
								PIN_OSPEEDR(9,GPIO_Speed_2MHz) |	\
								PIN_OSPEEDR(10,GPIO_Speed_2MHz) |	\
...
#define	CARIBOU_PORTF_PUPDR		PIN_PUPDR(0,GPIO_PuPd_NOPULL) |	\
								...
								PIN_PUPDR(4,GPIO_PuPd_NOPULL) |	\
								PIN_PUPDR(5,GPIO_PuPd_NOPULL) |	\
								PIN_PUPDR(6,GPIO_PuPd_NOPULL) |			/* LED1 */	\
								PIN_PUPDR(7,GPIO_PuPd_NOPULL) |	\
								PIN_PUPDR(8,GPIO_PuPd_NOPULL) |	\
								PIN_PUPDR(9,GPIO_PuPd_NOPULL) |	\
								PIN_PUPDR(10,GPIO_PuPd_NOPULL) |	\
...
#define	CARIBOU_PORTG_OSPEEDR	PIN_OSPEEDR(0,GPIO_Speed_2MHz) |	\
								...
								PIN_OSPEEDR(9,GPIO_Speed_2MHz) |	\
								PIN_OSPEEDR(10,GPIO_Speed_2MHz) |	\
								PIN_OSPEEDR(11,GPIO_Speed_100MHz) |	/* ETH_MII_TX_EN/ETH_RMII_TX_EN -----> PG11 */	\
								PIN_OSPEEDR(12,GPIO_Speed_2MHz) |	/* CC3000 ENABLE */	\
								...
								PIN_OSPEEDR(15,GPIO_Speed_2MHz)		/* CC3000 INTERRUPT */
...
#define	CARIBOU_PORTG_PUPDR		PIN_PUPDR(0,GPIO_PuPd_NOPULL) |	\
								...
								PIN_PUPDR(12,GPIO_PuPd_NOPULL) |	/* CC3000 ENABLE */	\
								...
								PIN_PUPDR(15,GPIO_PuPd_NOPULL)		/* CC3000 INTERRUPT */
...
#define	CARIBOU_PORTG_AFRH		PIN_AFR(0,GPIO_AF_GPIO) |	\
								PIN_AFR(1,GPIO_AF_GPIO) |	\
								PIN_AFR(2,GPIO_AF_GPIO) |	\
								PIN_AFR(3,GPIO_AF_ETH) |			/* ETH_MII_TX_EN/ETH_RMII_TX_EN -----> PG11 */	\
								PIN_AFR(4,GPIO_AF_GPIO) |			/* CC3000 ENABLE */		\
								PIN_AFR(5,GPIO_AF_ETH) |			/* ETH_MII_TXD0/ETH_RMII_TXD0 -------> PG13 */	\
								PIN_AFR(6,GPIO_AF_ETH) |			/* ETH_MII_TXD1/ETH_RMII_TXD1 -------> PG14 */	\
								PIN_AFR(7,GPIO_AF_GPIO)				/* CC3000 INTERRUPT */
/**
 ** PORT H
 */
