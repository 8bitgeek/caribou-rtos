...
extern caribou_gpio_t pb1;
extern caribou_gpio_t pb2;
 ...
 ** PORT A
 */
#define	CARIBOU_PORTA_CONFIG_L	PIN_MODE(0,GPIO_CNF_IN_PUD | GPIO_MODE_IN) |		/* BUTTON 1 */ \
								...
								PIN_MODE(6,GPIO_CNF_AF_PP | GPIO_MODE_OUT_50MHZ) |	/* PWM BOOST */ \
...
#define	CARIBOU_PORTC_CONFIG_L	PIN_MODE(0,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								...
								PIN_MODE(4,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(5,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(6,GPIO_CNF_OUT_PP | GPIO_MODE_OUT_2MHZ) |	/* LED1 */	\
								PIN_MODE(7,GPIO_CNF_OUT_PP | GPIO_MODE_OUT_2MHZ)	/* LED2 */	
#define	CARIBOU_PORTC_CONFIG_H	PIN_MODE(0,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(1,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(2,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(3,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(4,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(5,GPIO_CNF_IN_PUD | GPIO_MODE_IN) |		/* BUTTON 2 */ \
								PIN_MODE(6,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(7,GPIO_CNF_IN | GPIO_MODE_IN)
/**
 ** PORT D 
...
#define	CARIBOU_PORTD_CONFIG_L	PIN_MODE(0,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								...
								PIN_MODE(6,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(7,GPIO_CNF_IN | GPIO_MODE_IN)
#define	CARIBOU_PORTD_CONFIG_H	PIN_MODE(0,GPIO_CNF_AF_PP | GPIO_MODE_OUT_2MHZ) |	/* RS485 USART3_TX */ \
								PIN_MODE(1,GPIO_CNF_IN | GPIO_MODE_IN) |			/* RS485 USART3_RX */ \
								PIN_MODE(2,GPIO_CNF_OUT_PP | GPIO_MODE_OUT_2MHZ) |	/* RS485 DIR */ \
								PIN_MODE(3,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(4,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(5,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(6,GPIO_CNF_IN | GPIO_MODE_IN) |	\
