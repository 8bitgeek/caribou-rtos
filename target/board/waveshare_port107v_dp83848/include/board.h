...
extern caribou_gpio_t key1;
extern caribou_gpio_t key2;
extern caribou_gpio_t key3;

extern caribou_gpio_t joy1;
extern caribou_gpio_t joy2;
extern caribou_gpio_t joy3;
extern caribou_gpio_t joy4;
extern caribou_gpio_t joy5;
...
#define GPIO_MODE_OUT			GPIO_MODE_OUT_2MHZ
...
#define	CARIBOU_PORTB_CONFIG_H	PIN_MODE(0,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								...
								PIN_MODE(3,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(4,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(5,GPIO_CNF_IN_PUD | GPIO_MODE_IN) |	/* KEY1 */ \
								PIN_MODE(6,GPIO_CNF_IN_PUD | GPIO_MODE_IN) |	/* KEY2 */ \
								PIN_MODE(7,GPIO_CNF_IN_PUD | GPIO_MODE_IN)	/* KEY3 */ 
/**
 ** PORT C
 */
...
#define	CARIBOU_PORTD_CONFIG_L	PIN_MODE(0,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								...
								PIN_MODE(6,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(7,GPIO_CNF_IN | GPIO_MODE_IN)
#define	CARIBOU_PORTD_CONFIG_H	PIN_MODE(0,GPIO_CNF_IN_PUD | GPIO_MODE_IN) |	/* JOY1 */ \
								PIN_MODE(1,GPIO_CNF_IN_PUD | GPIO_MODE_IN) |	/* JOY2 */ \
								PIN_MODE(2,GPIO_CNF_IN_PUD | GPIO_MODE_IN) |	/* JOY3 */ \
								PIN_MODE(3,GPIO_CNF_IN_PUD | GPIO_MODE_IN) |	/* JOY4 */ \
								PIN_MODE(4,GPIO_CNF_IN_PUD | GPIO_MODE_IN) |	/* JOY5 */ \
								PIN_MODE(5,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(6,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(7,GPIO_CNF_IN | GPIO_MODE_IN)
/**
...
#define	CARIBOU_PORTE_CONFIG_L	PIN_MODE(0,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								...
								PIN_MODE(5,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(6,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(7,GPIO_CNF_OUT_PP | GPIO_MODE_OUT)		/* LED1 */ 
#define	CARIBOU_PORTE_CONFIG_H	PIN_MODE(0,GPIO_CNF_OUT_PP | GPIO_MODE_OUT) |	/* LED2 */ \
								PIN_MODE(1,GPIO_CNF_OUT_PP | GPIO_MODE_OUT) |	/* LED3 */ \
								PIN_MODE(2,GPIO_CNF_OUT_PP | GPIO_MODE_OUT) |	/* LED4 */ \
								PIN_MODE(3,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(4,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(5,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(6,GPIO_CNF_IN | GPIO_MODE_IN) |	\
