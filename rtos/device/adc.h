...
extern int				caribou_adc_start(caribou_adc_t* gpio);
extern int				caribou_adc_ready(caribou_adc_t* gpio);
extern chip_adc_value_t	caribou_adc_value(caribou_adc_t* gpio);
