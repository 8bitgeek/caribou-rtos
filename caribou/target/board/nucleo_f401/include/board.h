/******************************************************************************
* Copyright © 2005-2017 by Pike Aerospace Research Corporation
* All Rights Reserved
*
...
#define	CARIBOU_PORTA_MODE		PIN_MODE(0,GPIO_Mode_IN) |	\
								...
								PIN_MODE(5,GPIO_Mode_OUT) |			/* LED1 (LD2 - Green LED) */	\
...
#define	CARIBOU_PORTA_OTYPER	PIN_OTYPER(0,GPIO_OType_PP) |	\
								...
								PIN_OTYPER(5,GPIO_OType_PP) |			/* LED1 (LD2 - Green LED) */	\
...
#define	CARIBOU_PORTA_OSPEEDR	PIN_OSPEEDR(0,GPIO_Speed_2MHz) |	\
								...
								PIN_OSPEEDR(5,GPIO_Speed_2MHz) |			/* LED1 (LD2 - Green LED) */	\
...
#define	CARIBOU_PORTA_PUPDR		PIN_PUPDR(0,GPIO_PuPd_NOPULL) |	\
								...
								PIN_PUPDR(5,GPIO_PuPd_NOPULL) |			/* LED1 (LD2 - Green LED) */	\
...
#define	CARIBOU_PORTA_AFRL		PIN_AFR(0,GPIO_AF_GPIO) |	\
								...
								PIN_AFR(5,GPIO_AF_GPIO) |			/* LED1 (LD2 - Green LED) */	\
