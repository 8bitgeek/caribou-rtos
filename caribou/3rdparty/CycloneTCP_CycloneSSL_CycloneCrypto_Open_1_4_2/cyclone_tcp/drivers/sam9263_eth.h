...
#ifndef SAM9263_TX_BUFFER_COUNT
   #define SAM9263_TX_BUFFER_COUNT 3
#elif (SAM9263_TX_BUFFER_COUNT < 1)
   #error SAM9263_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef SAM9263_TX_BUFFER_SIZE
   #define SAM9263_TX_BUFFER_SIZE 1536
#elif (SAM9263_TX_BUFFER_SIZE != 1536)
   #error SAM9263_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef SAM9263_RX_BUFFER_COUNT
   #define SAM9263_RX_BUFFER_COUNT 72
#elif (SAM9263_RX_BUFFER_COUNT < 12)
   #error SAM9263_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef SAM9263_RX_BUFFER_SIZE
   #define SAM9263_RX_BUFFER_SIZE 128
#elif (SAM9263_RX_BUFFER_SIZE != 128)
   #error SAM9263_RX_BUFFER_SIZE parameter is not valid
#endif
