...
#ifndef M2SXXX_TX_BUFFER_COUNT
   #define M2SXXX_TX_BUFFER_COUNT 2
#elif (M2SXXX_TX_BUFFER_COUNT < 1)
   #error M2SXXX_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef M2SXXX_TX_BUFFER_SIZE
   #define M2SXXX_TX_BUFFER_SIZE 1536
#elif (M2SXXX_TX_BUFFER_SIZE != 1536)
   #error M2SXXX_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef M2SXXX_RX_BUFFER_COUNT
   #define M2SXXX_RX_BUFFER_COUNT 4
#elif (M2SXXX_RX_BUFFER_COUNT < 1)
   #error M2SXXX_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef M2SXXX_RX_BUFFER_SIZE
   #define M2SXXX_RX_BUFFER_SIZE 1536
#elif (M2SXXX_RX_BUFFER_SIZE != 1536)
   #error M2SXXX_RX_BUFFER_SIZE parameter is not valid
#endif
