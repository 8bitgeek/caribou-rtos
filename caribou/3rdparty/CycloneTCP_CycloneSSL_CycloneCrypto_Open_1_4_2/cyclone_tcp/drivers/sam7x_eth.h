...
#ifndef SAM7X_TX_BUFFER_COUNT
   #define SAM7X_TX_BUFFER_COUNT 2
#elif (SAM7X_TX_BUFFER_COUNT < 1)
   #error SAM7X_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef SAM7X_TX_BUFFER_SIZE
   #define SAM7X_TX_BUFFER_SIZE 1536
#elif (SAM7X_TX_BUFFER_SIZE != 1536)
   #error SAM7X_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef SAM7X_RX_BUFFER_COUNT
   #define SAM7X_RX_BUFFER_COUNT 48
#elif (SAM7X_RX_BUFFER_COUNT < 12)
   #error SAM7X_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef SAM7X_RX_BUFFER_SIZE
   #define SAM7X_RX_BUFFER_SIZE 128
#elif (SAM7X_RX_BUFFER_SIZE != 128)
   #error SAM7X_RX_BUFFER_SIZE parameter is not valid
#endif
