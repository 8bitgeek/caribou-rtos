...
#ifndef LPC175X_TX_BUFFER_COUNT
   #define LPC175X_TX_BUFFER_COUNT 2
#elif (LPC175X_TX_BUFFER_COUNT < 1)
   #error LPC175X_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef LPC175X_TX_BUFFER_SIZE
   #define LPC175X_TX_BUFFER_SIZE 1536
#elif (LPC175X_TX_BUFFER_SIZE != 1536)
   #error LPC175X_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef LPC175X_RX_BUFFER_COUNT
   #define LPC175X_RX_BUFFER_COUNT 4
#elif (LPC175X_RX_BUFFER_COUNT < 1)
   #error LPC175X_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef LPC175X_RX_BUFFER_SIZE
   #define LPC175X_RX_BUFFER_SIZE 1536
#elif (LPC175X_RX_BUFFER_SIZE != 1536)
   #error LPC175X_RX_BUFFER_SIZE parameter is not valid
#endif
