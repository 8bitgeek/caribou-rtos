...
#ifndef LPC18XX_TX_BUFFER_COUNT
   #define LPC18XX_TX_BUFFER_COUNT 2
#elif (LPC18XX_TX_BUFFER_COUNT < 1)
   #error LPC18XX_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef LPC18XX_TX_BUFFER_SIZE
   #define LPC18XX_TX_BUFFER_SIZE 1536
#elif (LPC18XX_TX_BUFFER_SIZE != 1536)
   #error LPC18XX_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef LPC18XX_RX_BUFFER_COUNT
   #define LPC18XX_RX_BUFFER_COUNT 6
#elif (LPC18XX_RX_BUFFER_COUNT < 1)
   #error LPC18XX_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef LPC18XX_RX_BUFFER_SIZE
   #define LPC18XX_RX_BUFFER_SIZE 1536
#elif (LPC18XX_RX_BUFFER_SIZE != 1536)
   #error LPC18XX_RX_BUFFER_SIZE parameter is not valid
#endif
