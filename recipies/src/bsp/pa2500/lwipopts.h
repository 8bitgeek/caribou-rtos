...
#define LWIP_TCPIP_THREAD_ALIVE() caribou_thread_watchdog_feed_self()
 ...
 */
	...
	#define 	SNMP_LWIP_ENTERPRISE_OID   		38579
	#define 	SNMP_DEVICE_ENTERPRISE_OID   	{1, 3, 6, 1, 4, 1, SNMP_LWIP_ENTERPRISE_OID}
	#define 	SNMP_DEVICE_ENTERPRISE_OID_LEN   7
	#define 	SNMP_LWIP_MIB2_SYSDESC   		"Pike Aero PA2600"
	#define 	SNMP_LWIP_MIB2_SYSNAME   		"pikeaero.com"
	#define 	SNMP_LWIP_MIB2_SYSCONTACT   	"sales@pikeaero.com"
	#define 	SNMP_LWIP_MIB2_SYSLOCATION  	"Canada"
#endif
...
/**
 * If defined LwIP does not do any asserts, reducing memory requirements.
 * @NOTE Should be commented out when debugging
 */
 ...
 */
#define TCP_DEFAULT_LISTEN_BACKLOG      6
 ...
 * sys_thread_new() when the thread is created.
 */
#define DEFAULT_THREAD_STACKSIZE        SYS_DEFAULT_THREAD_STACK_DEPTH
