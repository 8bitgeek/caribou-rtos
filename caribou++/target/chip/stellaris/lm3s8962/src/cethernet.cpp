...
namespace CARIBOU
{
	...
	CEthernet*				CEthernet::mEthernetInstance;
	struct uip_eth_addr		CEthernet::mMacAddr;

	#define inherited CEthernet_Base

	CEthernet::CEthernet(const char* name, uint16_t stksize, uint16_t priority)
	...
	*/
	void CEthernet::tcpListen( int16_t port )
	{
	...
	*/
	void CEthernet::addTcpListeners()
	{
	...
	*/
	void CEthernet::tcpUnListen( int16_t port )
	{
		mTCPListenerMutex.lock();
	...
	* @brief De-queue listener ports and set up tcp listeners. Executes in uIP thread.
	*/
	void CEthernet::removeTcpListeners()
	{
	...
	*/
	void CEthernet::arpTimer()
	{
		uip_arp_timer();
	}

	int32_t CEthernet::send()
	{
		return 0;
	}
	...
	*/
	CEthernet::tPacket* CEthernet::rxDequeue()
	{
		if ( !rxQueueEmpty() )
		{
	...
	*/
	CEthernet::tPacket* CEthernet::rxEnqueue()
	{
		if ( !rxQueueFull() )
		{
	...
	*/
	bool CEthernet::txEnqueue(uint8_t* buf, uint32_t len)
	{
	...
	*/
	CEthernet::tPacket* CEthernet::txDequeue()
	{
		if ( !txQueueEmpty() )
		{
			tPacket* p = mTXQueue.at(mTXQueueTail++);
	...
	*/
	 ...
	 * transmitter.
	 */
	void CEthernet::irq(CObject::Vector v)
	{
		uint32_t ulTemp;
	...
	//
	//*****************************************************************************
	void CEthernet::hwConfigSet(uint32_t ulConfig)
	{
		uint32_t ulTemp;
	...
	//
	//*****************************************************************************
	uint32_t CEthernet::hwConfigGet()
	{
	...
	//! \return None.
	//*****************************************************************************
	void CEthernet::hwMACAddrSet(unsigned char *pucMACAddr)
	{
	...
	//! \return None.
	//*****************************************************************************
	void CEthernet::hwMACAddrGet(uint8_t *pucMACAddr)
	{
		unsigned long ulTemp;
		unsigned char *pucTemp = (unsigned char *)&ulTemp;
	...
	//
	//*****************************************************************************
	int32_t CEthernet::hwPacketGetInternal(uint8_t *pucBuf, int32_t lBufLen)
	{
	...
	//
	//*****************************************************************************
	int32_t CEthernet::hwPacketGetNonBlocking(uint8_t *pucBuf,int32_t lBufLen)
	{
		/*
	...
	//
	//*****************************************************************************
	int32_t CEthernet::hwPacketGet(uint8_t *pucBuf, int32_t lBufLen)
	{
		/*
	...
	//
	//*****************************************************************************
	int32_t CEthernet::hwPacketPutInternal(uint8_t *pucBuf,
	int32_t lBufLen)
	{
		unsigned long ulTemp;
		register long i = 0;
	...
	//
	//*****************************************************************************
	int32_t CEthernet::hwPacketPutNonBlocking(uint8_t* pucBuf,int32_t lBufLen)
	{
		/*
	...
	//*****************************************************************************
	int32_t
	CEthernet::hwPacketPut(uint8_t *pucBuf, int32_t lBufLen)
	{
		/*
	...
	//! \return None.
	//*****************************************************************************
	void CEthernet::hwIntDisable(uint32_t ulIntFlags)
	{
	...
	//! \return None.
	//*****************************************************************************
	void CEthernet::hwIntEnable(uint32_t ulIntFlags)
	{
	...
	//*****************************************************************************
	uint32_t CEthernet::hwIntStatus(bool bMasked)
	{
	...
	//! \return None.
	//*****************************************************************************
	void CEthernet::hwIntClear(uint32_t ulIntFlags)
	{
	...
	//! disabled by calling the CEthernet::disable() function and the controller must
	//! be reinitialized by calling the CEthernet::initializeClock() function again.  After
	//! the controller has been reinitialized, the controller should be
	//! reconfigured using the appropriate Ethernet API calls.
	//!
	//! \return None.
	//*****************************************************************************
	void CEthernet::hwInitExpClk(uint32_t ulEthClk)
	{
		unsigned long ulDiv;
	...
	//*****************************************************************************
	void
	CEthernet::hwPHYWrite(uint8_t ucRegAddr,uint32_t ulData)
	{
		/*
	...
	//
	//*****************************************************************************
	uint32_t CEthernet::hwPHYRead(unsigned char ucRegAddr)
	{
		/*
		** Wait for any pending transaction to complete.
		*/
	...
	//! \return None.
	//*****************************************************************************
	void CEthernet::setEthernetLEDPins(uint32_t ulPort,uint8_t ucPins)
	{
