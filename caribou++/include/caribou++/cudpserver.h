...
namespace CARIBOU
{
	...
	{
		public:
			CUdpServer(uint16_t port, uint32_t interface=INADDR_ANY, int backlog=8, const char* name="tcpsrv", size_t stksize=512, uint16_t priority=0, uint16_t watchdog_count=0 );
			virtual ~CUdpServer();
