...
#define	CARIBOU_PORTE_CONFIG_L	PIN_MODE(0,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(1,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(2,GPIO_CNF_IN | GPIO_MODE_IN) |	\
								PIN_MODE(3,	GPIO_CNF_OUT_PP | GPIO_MODE_OUT_2MHZ) |	/* LED1 */	\
								PIN_MODE(4,	GPIO_CNF_OUT_PP | GPIO_MODE_OUT_2MHZ) |	/* LED2 */	\
								PIN_MODE(5,	GPIO_CNF_OUT_PP | GPIO_MODE_OUT_2MHZ) |	/* LED3 */	\
								PIN_MODE(6,	GPIO_CNF_OUT_PP | GPIO_MODE_OUT_2MHZ) |	/* LED4 */	\
								PIN_MODE(7,GPIO_CNF_IN | GPIO_MODE_IN)
