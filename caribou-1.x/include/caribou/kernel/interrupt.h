...
extern int	caribou_vector_enabled(InterruptVector vector);
extern int	caribou_vector_enable(InterruptVector vector);
extern int	caribou_vector_disable(InterruptVector vector);
extern int	caribou_vector_set(InterruptVector vector,int state);
